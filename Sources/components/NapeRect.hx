...
class NapeRect extends Component{
	//initialize
	...
	public var lw=5.0;
	public function new(space:Space,x:Float=300.0,y:Float=100.0,w:Float=100.0,h:Float=100.0,lw:Float=6.0,color:Color=Color.Green){
		super();
		this.w=w;
		this.h=h;
		this.lw=lw;
